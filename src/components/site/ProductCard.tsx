  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="flex flex-1 flex-col gap-1.5 p-3">
        ...
        <span className="text-xs text-zinc-500">{product.packageSize}</span>
        ...
        <div className="mt-auto flex items-center justify-between gap-2 pt-1">
          <div className="flex flex-col">
            ...
            {hasBulkPricing && <span className="text-xs text-brand-primary-dark dark:text-brand-primary">Bulk pricing available</span>}
          </div>
